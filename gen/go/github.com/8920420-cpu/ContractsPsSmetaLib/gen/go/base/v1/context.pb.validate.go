...
// Validate checks the field values on CollBack with the rules defined in the
// proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
func (m *CollBack) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on CollBack with the rules defined in
// the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in CollBackMultiError, or nil
// if none found.
func (m *CollBack) ValidateAll() error {
	return m.validate(true)
}

func (m *CollBack) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return CollBackMultiError(errors)
	}

	return nil
}

// CollBackMultiError is an error wrapping multiple validation errors returned
// by CollBack.ValidateAll() if the designated constraints aren't met.
type CollBackMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m CollBackMultiError) Error() string {
...
func (m CollBackMultiError) AllErrors() []error { return m }

// CollBackValidationError is the validation error returned by
// CollBack.Validate if the designated constraints aren't met.
type CollBackValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
func (e CollBackValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e CollBackValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e CollBackValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e CollBackValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e CollBackValidationError) ErrorName() string { return "CollBackValidationError" }

// Error satisfies the builtin error interface
func (e CollBackValidationError) Error() string {
	cause := ""
	if e.cause != nil {
...
var _ error = CollBackValidationError{}
...
func (m *RequestContext) validate(all bool) error {
	...
	// no validation rules for CallerInstanceId
	...
	if all {
		switch v := interface{}(m.GetCollBack()).(type) {
	...
	} else if v, ok := interface{}(m.GetCollBack()).(interface{ Validate() error }); ok {
		if err := v.Validate(); err != nil {
